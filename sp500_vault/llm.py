...
_RAG_SYSTEM = (
    ...
    "insufficient, say so.\n"
    "GROUNDING — stay strictly within the context: state ONLY what the provided "
    "context supports. Do NOT introduce specific product names, part numbers, dollar "
    "amounts, percentages, or dates that are not present in the context, even if you "
    "believe them to be true. When the context establishes a relationship (e.g. 'X is "
    "a supplier to Y') but not the specific component or figure, describe the "
    "relationship in general terms — do not invent the specifics. Prefer to "
    "under-claim: if the question asks for detail the context does not contain, answer "
    "with what IS supported and note that the finer detail isn't in the vault.\n"
